      ...
      <section className="sticky top-[72px] z-30 bg-white/80 backdrop-blur-md border-b border-slate-100 py-6">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <ScrollReveal direction="none" distance={0} className="flex items-center gap-3 text-slate-900 font-bold">
            ...
            <AnimatePresence mode="popLayout">
              {filteredRealizations.map((item, index) => (
                <motion.div
                  ...
                  key={item.title}
                  className="group bg-white rounded-[40px] overflow-hidden border border-slate-100 shadow-sm hover:shadow-2xl transition-shadow duration-500"
                >
                  ...
                  <div className="p-10 space-y-8">
                    <div className="flex flex-wrap gap-4 text-xs font-bold text-slate-400">
                      <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-slate-50 border border-slate-100 transition-colors group-hover:bg-slate-100">
                    ...
                    <div className="pt-6 border-t border-slate-50 flex flex-wrap gap-2">
                      {item.tags.map(tag => (
                        <span key={tag} className="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-widest text-[#012347]/60 bg-blue-50/50 px-3 py-1.5 rounded-lg border border-blue-100/30 transition-colors hover:bg-blue-100/50">
