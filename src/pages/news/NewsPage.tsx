        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-[1fr_360px] gap-12 text-left">
            ...
            <div className="space-y-12">
              <ScrollReveal direction="up" distance={20} className="flex items-center justify-between border-b border-slate-100 pb-8">
              ...
              <div className="grid gap-8">
                {newsItems.map((item, index) => (
                  <ScrollReveal direction="up" delay={index * 0.1} key={item.id}>
                    <motion.article
                      layout
                    ...
                    >
                      ...
                      <div className="flex flex-col justify-center space-y-5">
                        <div className="flex items-center gap-4">
                          <span className="px-4 py-1.5 rounded-full bg-emerald-50 text-sole-green text-[10px] font-bold uppercase tracking-widest border border-emerald-100/50 transition-colors group-hover:bg-emerald-100">
                            {item.category}
                          </span>
            ...
            <aside className="space-y-8">
              <ScrollReveal direction="left" delay={0.2}>
                <div className="bg-[#022c5a] rounded-[40px] p-8 shadow-2xl text-white relative overflow-hidden transition-all duration-500 hover:shadow-[0_20px_40px_rgba(2,44,90,0.3)]">
                  <div className="absolute top-0 right-0 p-6 opacity-10 transition-transform duration-500 hover:rotate-12 hover:scale-110">
                  ...
                  <div className="space-y-8">
                    {tenders.map((tender) => (
                      <div key={tender.ref} className="group border-b border-white/10 pb-6 last:border-0 last:pb-0">
                        ...
                        >
                          {tender.title}
                          <LinkOutlined className="ml-2 text-xs opacity-50 transition-opacity group-hover:opacity-100" />
                        </a>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full mt-10 py-5 bg-white text-[#012347] rounded-[24px] text-[10px] font-black uppercase tracking-widest hover:bg-sole-green hover:text-white transition-all inline-block text-center shadow-lg hover:shadow-xl hover:-translate-y-1"
                  >
              ...
              <ScrollReveal direction="left" delay={0.3}>
                <div className="bg-emerald-50 border border-emerald-100 rounded-[40px] p-8 transition-colors hover:bg-emerald-100/50">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full py-4 bg-sole-blue text-white rounded-[20px] text-xs font-bold hover:bg-sole-green transition-all inline-block text-center font-sans tracking-wide hover:shadow-lg hover:-translate-y-0.5"
                  >
