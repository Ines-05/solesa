        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {infrastructures.map((infra, idx) => (
            <div key={idx} className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              <ScrollReveal direction="left" delay={0.2} className="order-1 lg:order-2 space-y-6">
                {/* Main Large Image */}
      ...
      <section className="py-24 bg-white border-t border-slate-100">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <ScrollReveal direction="up" distance={30}>
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 bg-sole-blue rounded-[50px] p-10 lg:p-14 text-white hover:shadow-2xl transition-all duration-500 group">
              ...
              <div className="shrink-0">
                <a
                  ...
                  className="inline-block px-10 py-5 rounded-full bg-sole-green text-white font-bold hover:bg-white hover:text-sole-blue transition-all text-center group-hover:scale-105 shadow-xl shadow-sole-green/20"
                >
